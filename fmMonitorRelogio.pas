...
procedure TfMonitorRelogio.CreateParams(var Params: TCreateParams);
begin
...
procedure TfMonitorRelogio.FormActivate(Sender: TObject);
begin
  fmIndex.btExp_Relogio.ImageIndex := 11;
end;
...
begin
  ...
  fmIndex.btExp_Relogio.ImageIndex := 10;
end;
